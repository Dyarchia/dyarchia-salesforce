...
Credentials and identity live in `dya-sf-integration-auth`; async and governor depth in `dya-sf-apex`;
Lightning Web Security and CSP in `dya-sf-lwc`; what the calling user is allowed to read in
`dya-sf-permissions`.
...
├─ NO (fire-and-forget)
│   ├─ Notify and forget ............................. Platform Event (dya-sf-integration-events)
