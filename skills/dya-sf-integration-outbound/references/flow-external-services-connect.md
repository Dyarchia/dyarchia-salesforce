...
Load from `dya-sf-integration-outbound` for the no-code/declarative outbound paths and data virtualization. All paths use Named Credentials (`dya-sf-integration-auth`).
