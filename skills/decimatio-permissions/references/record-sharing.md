...
Load from `decimatio-permissions` for the "which records can the user see" axis. Access widens through a pipeline from a restrictive baseline; restriction/scoping rules narrow.
