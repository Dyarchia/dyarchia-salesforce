...
|---|---|---|
| Any net-new Lightning Experience UI | LWC (`dya-lwc`) | NO |
| LWC can't express it, but Aura can (e.g. needs an Aura-only base component) | Aura (`dya-aura`) | NO |
...
|---|---|
| New LEX UI built in Visualforce | LWC (`dya-lwc`), then Aura |
