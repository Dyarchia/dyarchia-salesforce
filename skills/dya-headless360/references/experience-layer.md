...
| UI only ever shown in Lightning Experience | **LWC** (`dya-lwc`), or Aura (`dya-aura`) for the rare gap |
| Server-rendered PDF / Classic / email template | **Visualforce** (`dya-visualforce`) |
