...
|---|---|---|
| Execute Data 360 SQL from Apex | GA | Run a Data 360 SQL query directly from Apex, so custom logic and Data 360 data live in one class instead of an integration between them. See `dya-sf-apex` |
