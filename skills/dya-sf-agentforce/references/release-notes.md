...
| MCP interoperability | GA | An agent discovers and calls tools on external MCP servers through a governed connection, instead of every capability being rebuilt as a local action. See `dya-sf-integration-connectors-mcp` |
