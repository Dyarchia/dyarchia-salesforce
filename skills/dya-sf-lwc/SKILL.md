...
the agent itself is `dya-sf-agentforce`.

## 7. The `@AuraEnabled` Contract

This is the only server-side surface this skill owns. Everything else about Apex is `dya-sf-apex`.
