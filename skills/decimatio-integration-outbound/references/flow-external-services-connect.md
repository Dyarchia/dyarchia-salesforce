...
Load from `decimatio-integration-outbound` for the no-code/declarative outbound paths and data virtualization. All paths use Named Credentials (`decimatio-integration-auth`).
