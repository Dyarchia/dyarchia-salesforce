...
- `dya-sf-integration-outbound` — Salesforce calling out: Apex callouts and async patterns, Flow HTTP Callout, External Services, Outbound Messages, Salesforce Connect, LWC to external.
- `dya-sf-integration-events` — Platform Events, Change Data Capture, Pub/Sub API, webhook patterns.
- `dya-sf-integration-auth` — OAuth flows, External Client Apps vs Connected Apps, Named and External Credentials, the username-password and SOAP `login()` retirements.
- `dya-sf-integration-connectors-mcp` — MuleSoft, Heroku, AppExchange, hosted MCP servers, Headless 360, Agent API.
...
│    ├─ Standard data operations (CRUD/query/bulk) ... dya-sf-integration-inbound-apis
│    └─ Custom endpoint / bespoke contract .......... dya-sf-integration-inbound-apex
├─ Salesforce calls external .................. OUTBOUND
│    └─ Apex, Flow, External Services, Connect, LWC . dya-sf-integration-outbound
├─ Either side reacts to an event ............. EVENT-DRIVEN
│    └─ Platform Events, CDC, Pub/Sub .............. dya-sf-integration-events
└─ Don't hand-code it ......................... CONNECTORS
     └─ MuleSoft, MCP, AppExchange ................ dya-sf-integration-connectors-mcp
...
- **Analytics latency under 15 minutes** → streaming; otherwise batch. See `dya-sf-data360`.
