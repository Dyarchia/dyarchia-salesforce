...
Load from `dya-b2c-commerce` for headless/API development. **OCAPI is deprecated as of April 2026** (2 years security-only, no new features); all new work uses SCAPI.
