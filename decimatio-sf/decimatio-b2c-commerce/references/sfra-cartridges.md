...
Load from `decimatio-b2c-commerce`. Server-side B2C Commerce development: cartridges, controllers, `dw.*` Script API, ISML, hooks, jobs. This is JavaScript on the B2C Commerce Script API (Rhino-based) — **not** Node.js, **not** Apex.
