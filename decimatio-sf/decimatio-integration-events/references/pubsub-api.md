...
Load from `decimatio-integration-events` when an external system must publish or subscribe to Salesforce events. The Pub/Sub API is the strategic gRPC interface for Platform Events, Change Data Capture, and Real-Time Event Monitoring.
