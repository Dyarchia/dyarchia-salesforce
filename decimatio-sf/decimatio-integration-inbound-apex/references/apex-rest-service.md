...
Load from `decimatio-integration-inbound-apex` when building a custom inbound REST endpoint. Apex REST is GA and recommended; this is the canonical multi-verb, transactional, securely-bounded service. Deep Apex rules (bulkification, async, logging) live in `decimatio-apex`.
