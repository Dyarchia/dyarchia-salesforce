...
Load from `decimatio-revenue-cloud`. Salesforce Pricing on the Business Rules Engine, Product Catalog Management, and Product Configurator — with real endpoints/actions. Source: Revenue Lifecycle Management Developer Guide v67.0. Confirm exact request bodies against the guide for your version.
