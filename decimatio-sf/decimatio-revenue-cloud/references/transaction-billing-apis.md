...
Load from `decimatio-revenue-cloud`. The transactional and post-sale domains with real Connect endpoints, Apex, and invocable actions. Source: Revenue Lifecycle Management Developer Guide v67.0. Confirm exact request/response bodies per version.
...
| Headless quote/checkout | Connect REST business APIs (+ OAuth, `decimatio-integration-auth`) |
